		...
		<div class="col-12 col-md-12 offset-lg-1 col-lg-10 offset-xl-1 col-xl-10 my-4">
			<div class="row">
				...
				<div v-for="dienst in diensten" class="col-12 col-md-12 col-lg-12 col-xl-12 mb-4">
					<div id="dienst" class="dienst">
						<div class="d-flex">
							<span class="dienstNaam p-2 fs-4 bg-white w-100 fw-bold">{{ dienst.naam }}</span>
							<span class="dienstPrijs p-2 fs-3 bg-dark-purple fw-bold">€{{ dienst.prijs.includes('.00') ? dienst.prijs : dienst.prijs+'.00' }}</span>
						</div>
